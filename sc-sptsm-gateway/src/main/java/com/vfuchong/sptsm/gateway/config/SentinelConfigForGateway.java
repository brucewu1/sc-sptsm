package com.vfuchong.sptsm.gateway.config;
...
import com.vfuchong.sptsm.gateway.routedefine.CustomApiDefinition;
import com.vfuchong.sptsm.gateway.routedefine.SentinelDefinition;
...
public class SentinelConfigForGateway {
    ...
    private String groupId = GatewayConstans.GROUP_GATEWAY;
    private String dataId = GatewayConstans.DATA_ID_FLOW;
